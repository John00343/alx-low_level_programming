...
/**
 * is_chain - Checks if current char in buf is chain delimeter
 ...
 * @buf: the Char buf
 * @p: address to present position in buf
...
/**
 * replace_alias - replaces alias in a tokenized string
 * @info: The Parameter struct
 *
